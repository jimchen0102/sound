  ...
  <div class="pointer-events-none fixed inset-0 overflow-hidden">
    <div class="absolute left-1/2 top-1/2 w-[120%] -translate-x-1/2 -translate-y-1/2 rotate-[-12.5deg]">
      <div
        v-for="num in 6"
        :key="num"
        class="border-b-[1vh] border-white opacity-[.15] [&_div]:odd:animate-[marquee_40s_linear_reverse_infinite] [&_div]:odd:bg-[url('@/assets/img/text-decoration.png')] [&_div]:even:animate-[marquee_40s_linear_infinite] [&_div]:even:bg-[url('@/assets/img/arrow-decoration.png')]"
      >
        <div class="h-[30vh] bg-[length:auto_100%]" />
      </div>
    </div>
